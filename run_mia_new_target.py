...
from audit import audit_models, sample_auditing_dataset, audit_model
...
from util import (
    ...
    initialize_seeds,
    create_directories,
    load_dataset, load_target_dataset,
)
...
def main():
    ...
    target_dataset, target_population = load_target_dataset(configs, directories["data_dir"], logger)
    target_model = get_model(configs["audit"]["model_name"], configs)

    mia_score_list = audit_model(
